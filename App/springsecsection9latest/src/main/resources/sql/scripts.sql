...
INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                    closing_balance, create_dt)  VALUES (1, 186576453434, 1, current_date-7, 'Coffee Shop', 'Withdrawal', 30,34500,CURDATE()-7);

INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                  closing_balance, create_dt)  VALUES (2, 186576453434, 1, current_date-6, 'Uber', 'Withdrawal', 100,34400,CURDATE()-6);

INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                  closing_balance, create_dt)  VALUES (3, 186576453434, 1, current_date-5, 'Self Deposit', 'Deposit', 500,34900,CURDATE()-5);

INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                  closing_balance, create_dt)  VALUES (4, 186576453434, 1, current_date-4, 'Ebay', 'Withdrawal', 600,34300,CURDATE()-4);

INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                    closing_balance, create_dt)  VALUES (5, 186576453434, 1, current_date-2, 'OnlineTransfer', 'Deposit', 700,35000,CURDATE()-2);

INSERT INTO account_transactions (transaction_id,account_number, customer_id, transaction_dt, transaction_summary, transaction_type,transaction_amt,
                                    closing_balance, create_dt)  VALUES (6, 186576453434, 1, current_date-1, 'Amazon.com', 'Withdrawal', 100,34900,CURDATE()-1);
